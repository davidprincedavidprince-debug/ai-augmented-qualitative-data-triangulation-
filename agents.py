...
entailment/contradiction check used on-demand from the UI. Neither call
decides anything on its own — the human always sees the raw number, the
raw text, and the raw verdict, and makes the actual call in the app.
"""
